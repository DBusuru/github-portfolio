    ...
    ***************************************************************************** */
    ...
    function canvasMutation$1(_0) {
      return __async$2(this, arguments, function* ({
        ...
        const mutationArgsPromises = mutations.map((mutation) => __async$2(this, null, function* () {
    ...
    class MediaManager {
      constructor(options) {
        this.mediaMap = /* @__PURE__ */ new Map();
        this.metadataCallbackMap = /* @__PURE__ */ new Map();
      ...
      getMediaStateFromMutation({
        ...
        const mediaState = {
          isPlaying,
          currentTimeAtLastInteraction: (_a = currentTime != null ? currentTime : lastState == null ? void 0 : lastState.currentTimeAtLastInteraction) != null ? _a : 0,
              ...
              if (value === null) {
                ...
                try {
                  ...
                  if (attributeName === "value" && target.nodeName === "TEXTAREA") {
                    ...
                    const tn = (_a = target.ownerDocument) == null ? void 0 : _a.createTextNode(value);
                    if (tn) {
